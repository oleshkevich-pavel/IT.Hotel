...
<%-- 			<th><mytaglib:sort-link pageUrl="${baseUrl}" column="id"><mytaglib:i18n key="id" /></mytaglib:sort-link></th> --%>
			...
			<th><mytaglib:sort-link pageUrl="${baseUrl}" column="roomPrice"><mytaglib:i18n key="totalPrice" /></mytaglib:sort-link></th>
...
<mytags:paging />
<div class="col s12">
	<a class="btn waves-effect waves-light right" href="${pageContext.request.contextPath}/roomsearch"><i class="material-icons left">reply</i><mytaglib:i18n key="back" /></a>
</div>
